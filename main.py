...
class MainApp(MDApp):
    ...
    def create_server(self):
        ...
        self.new_server = server.Server(self.root.ids.progress, self.root.ids.reception, self.root.ids.details_item, self.root.ids.sentreceived, self.root.ids.received)
        try:
    ...
    def select_path(self, path):
        ...
        try:
            ...
            self.new_client = client.Client(self.receiveraddress, 5001, path, self.root.ids.progress, self.root.ids.details_item)
